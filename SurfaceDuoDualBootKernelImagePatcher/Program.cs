namespace SurfaceDuoDualBootKernelImagePatcher
{
    ...
    internal class Program
    {
        ...
        static byte[] PatchKernel(byte[] kernelBuffer, byte[] uefiBuffer, SurfaceDuoProduct surfaceDuoProduct)
        {
            ...
            {
                0x84, 0x00, 0x92, 0xD2, // movz x4, #0x9004
                0xE4, 0x7A, 0xA0, 0xF2, // movk x4, #0x3d7, lsl #16
                ...
                0x84, 0x00, 0x05, 0x8B, // add x4, x4, x5
                0xE5, 0xFD, 0xFF, 0x58, // ldr x5, #0xffffffffffffffe0
                0x06, 0xFE, 0xFF, 0x58, // ldr x6, #0xffffffffffffffe8
                0x05, 0x00, 0x00, 0x94, // bl #0x40
                0x80, 0x01, 0x00, 0x10, // adr x0, #0x60
                0x61, 0x01, 0x00, 0x10, // adr x1, #0x60
                0x45, 0xFD, 0xFF, 0x58, // ldr x5, #0xffffffffffffffe0
                0xA0, 0x00, 0x1F, 0xD6, // br x5
                0x82, 0x0C, 0xC1, 0xA8, // ldp x2, x3, [x4], #0x10
                0xA2, 0x0C, 0x81, 0xA8, // stp x2, x3, [x5], #0x10
                0xC6, 0x40, 0x00, 0xF1, // subs x6, x6, #0x10
                0xA1, 0xFF, 0xFF, 0x54, // b.ne #0x40
                0xC0, 0x03, 0x5F, 0xD6, // ret 
                0x00, 0x00, 0x00, 0x14, // b #0x54
            ...
            {
                0x84, 0x00, 0x80, 0xD2, // movz x4, #0x4
